...
public class Main2Activity extends AppCompatActivity {
    ...
    public int submit1(){
       /* EditText editTextOne = (EditText) findViewById(R.id.edit_text_one);
        ...
        int firstNumber = Integer.parseInt(editTextOne.getText());
        int secondNumber = Integer.parserInt(editTextTwo.getText());
       ...
       // Log.e(LOG_TAG, " " + this.findViewById(R.id.question3_choice3));
        ...
        //answer1_score = 10000;
        //Now send the result sum to the Activity 12 through intent.
        Intent intent = new Intent(this, Main12Activity.class);
        intent.putExtra("Question1 :", answer1_score);
        ///return answer1_score;
        //startActivity(intent);
        if (answer1_score == 1) {
            resultsDisplay = ""+answer1_score+"\nsuccess!"/*"Perfect! You scored 10 out of 10"*/;
        } else {
            resultsDisplay = ""+answer1_score+ "\nfail!"/*"Try again. You scored " + final_score + " out of 10"*/;
        }
